package com.iperovv.vkcourseproject.data.remote
...
import com.iperovv.vkcourseproject.data.remote.model.AppSummaryListDto
import com.iperovv.vkcourseproject.domain.model.AppCategory

class AppsApi {
    fun getDetailedApp(): AppDetailedDto =
        AppDetailedDto(
            name = "Гильдия Героев: Экшен ММО РПГ",
            developer = "VK Play",
            category = AppCategory.GAME.toString(),
            ageRating = 12,
            size = 223.7f,
            screenshotUrlList =
                listOf(
    ...
    fun getAppList(): AppSummaryListDto =
        AppSummaryListDto(
            List(15) {
                AppSummaryDto(
